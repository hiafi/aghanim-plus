...
-- copy from EXT
_G.BLESSING_PLAYER_ABSENSE_BONUS = 0.4

_G.BLESSING_LEVEL_HUB = {
	{
		bottle_charges = 0.5,
		stat_agi = 3,
		stat_int = 3,
		...
		stat_magic_resist = 3,
		starting_gold = 300,
		purification_potion = 1.5,
		death_detonation = 60,
		potion_health = 5,
		potion_mana = 5,
		respawn_time_reduction = 0.15,
		bottle_regen_duration = 0.5,
		bottle_regen_movement_speed = 6,
		roshan_shop_discount = 5,
		oracle_shop_discount = 5,
		respawn_invulnerability = 0.5,
		respawn_haste = 10,
		respawn_attack_speed = 15,
		stat_evasion = 2,
		upgrade_reroll = 3,
		elite_upgrade = 3,
		start_tome = 1,
		...
		cast_range = 10,
		damage_on_stunned = 4,
		regen_around_allies = 1,
		debuff_duration_increase = 2,
		low_hp_outgoing_damage = 4,
	},
	{
		bottle_charges = 1,
		stat_agi = 3,
		...
		potion_health = 10,
		potion_mana = 10,
		respawn_time_reduction = 0.2,
		bottle_regen_duration = 1,
		bottle_regen_movement_speed = 10,
		roshan_shop_discount = 10,
		oracle_shop_discount = 10,
		respawn_invulnerability = 1,
		respawn_haste = 20,
		respawn_attack_speed = 25,
		stat_evasion = 4,
		upgrade_reroll = 4,
		elite_upgrade = 4,
		start_tome = 3,
		...
		cast_range = 25,
		damage_on_stunned = 6,
		regen_around_allies = 1.5,
		debuff_duration_increase = 4,
		low_hp_outgoing_damage = 6,
	},	{
		bottle_charges = 1,
		stat_agi = 4,
		stat_int = 4,
		...
		stat_magic_resist = 5,
		starting_gold = 350,
		purification_potion = 2,
		death_detonation = 80,
		potion_health = 15,
		potion_mana = 15,
		respawn_time_reduction = 0.35,
		bottle_regen_duration = 1.5,
		bottle_regen_movement_speed = 15,
		roshan_shop_discount = 10,
		oracle_shop_discount = 10,
		respawn_invulnerability = 1.5,
		respawn_haste = 30,
		respawn_attack_speed = 35,
		stat_evasion = 6,
		upgrade_reroll = 5,
		elite_upgrade = 5,
		start_tome = 6,
		...
		cast_range = 35,
		damage_on_stunned = 8,
		regen_around_allies = 2,
		debuff_duration_increase = 6,
		low_hp_outgoing_damage = 8,
	},	{
		bottle_charges = 1,
		stat_agi = 4,
		stat_int = 4,
		...
		potion_health = 20,
		potion_mana = 20,
		respawn_time_reduction = 0.50,
		bottle_regen_duration = 2,
		bottle_regen_movement_speed = 20,
		roshan_shop_discount = 15,
		oracle_shop_discount = 15,
		respawn_invulnerability = 2,
		respawn_haste = 45,
		respawn_attack_speed = 45,
		stat_evasion = 8,
		upgrade_reroll = 6,
		elite_upgrade = 6,
		start_tome = 6,
		...
		projectile_speed = 25,
		cast_range = 45,
		damage_on_stunned = 10,
		regen_around_allies = 2.5,
		debuff_duration_increase = 8,
		low_hp_outgoing_damage = 10,
	},	{
		bottle_charges = 2,
		stat_agi = 5,
		stat_int = 5,
		...
		stat_magic_resist = 7,
		starting_gold = 400,
		purification_potion = 2.5,
		death_detonation = 100,
		potion_health = 25,
		potion_mana = 25,
		respawn_time_reduction = 0.65,
		bottle_regen_duration = 2.5,
		bottle_regen_movement_speed = 24,
		roshan_shop_discount = 20,
		oracle_shop_discount = 20,
		respawn_invulnerability = 3,
		respawn_haste = 60,
		respawn_attack_speed = 60,
		stat_evasion = 10,
		upgrade_reroll = 7,
		elite_upgrade = 7,
		start_tome = 9,
		...
		projectile_speed = 35,
		cast_range = 60,
		damage_on_stunned = 12,
		regen_around_allies = 3,
		debuff_duration_increase = 10,
		low_hp_outgoing_damage = 12,
	},
    {
		bottle_charges = 2,
		stat_agi = 5,
