...
function Awake()
	print("custom awake begins")
	LinkLuaModifier("modifier_dummy_thinker", "modifiers/ext/modifier_dummy_thinker.lua", LUA_MODIFIER_MOTION_NONE )
	LinkLuaModifier("modifier_generic_layer_stack", "modifiers/ext/modifier_generic_layer_stack", LUA_MODIFIER_MOTION_NONE)
